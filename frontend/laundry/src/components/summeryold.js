        ...
        <div className="third-section">
          ...
          <div className="address">
            ...
            <div className="address-box">
              <p name="address"className='homepara' onChange={handleinput2} value="Home:#223, 10th road, Jp Nagar, Bangalore" >
                <strong>Home</strong>
                #223, 10th road, Jp Nagar, Bangalore
              </p>
              <p name="address" className='homepara'  value="Other:#223, 10th road, Jp Nagar, Bangalore"  onChange={handleinput2} >
                <strong>Other</strong>
                #223, 10th road, Jp Nagar, Bangalore
              </p>
